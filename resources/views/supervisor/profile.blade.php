...
@section('title','WMU |  Supervisor Profile')
@section('content')
<div class="Wrap_all_class padzero">
    <div class="Wrap_all_class_inner paddtopbtm">
        {{ Form::open(array('route'=>'supervisor.profile.update','id'=>'supervisor')) }}
        <input type="hidden" name="id" class="supervisor_id" value="{{ isset($id) ? $id : null }}">
        ...
        <div class="full_width Tabs_cls_cool marg40">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                	@include('supervisor.partials._user-profile-section')                 
                </div>
            </div>
        </div>
        {{ Form::close() }}
...
@endsection
@section('extra')
    <script src="{{ asset('js/pages/supervisor/profile.js') }}" type="text/javascript"></script>
@endsection