        			...
        			<div class="right_bar_top_profile for_ctc_goal_UI">
        				<ul>
                            ...
                            @if(Auth::user()->user_type_id == superAdminUserTypeId() || Auth::user()->user_type_id == supervisorUserTypeId())
                                <li class="btn-edit-goal"><buttton type="button" onclick='window.location.href="{{ route('goal.edit',$goal_detail->id) }}"' class="sm_nwUIbtn ml-10">Edit Goal</button></li>
                            @endif
        		...
        		<div class="col-sm-4">
        			<div class="goal_box_item_cls">
        				...
        				<div class="for_scaling_box_listing">
        					@include('goal.view._goal-scalling')
        				</div>
        			</div>
        		</div>
        		<div class="col-sm-8">
        			<div class="goal_box_item_cls">
                        ...
                        @include('goal.view._goal-activity')
        			</div>
        		</div>
        	</div>
        </div>
