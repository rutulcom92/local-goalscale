...
class ParticipantRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch ($this->method()) {
            case 'POST':
            {
                ...
                $rules['users.email'] = 'required|email|max:199|unique:users,email,'.$this->participant;
                $rules['users.organization_id'] = 'required';
                $rules['user_programs.program_id'] = 'required';
                $rules['participant_provider.provider_id'] = 'required';
                ...
                $rules['userDetail.gender'] = 'required|max:50';
     ...
     public function messages()
    {
        ...
        $ruleMsg['participant_provider.provider_id'] = 'Please select the provider.';
        $ruleMsg['user_programs.program_id.required'] = 'Please select the programs.';
        $ruleMsg['users.organization_id'] = 'Please select the organization.';
        $ruleMsg['users.phone.required'] = 'Please provide the phone number';
        $ruleMsg['userDetail.dob.required'] = 'Please provide the date of birth.';
        ...
        $ruleMsg['userDetail.gender.required'] = 'Please select the gender.';
