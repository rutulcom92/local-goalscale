...
class ProviderRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch ($this->method()) {
            case 'POST':
            {
                ...
                $rules['provider_supervisor.supervisor_id'] = 'required';
                $rules['users.email'] = 'required|email|max:199|unique:users,email,'.$this->provider;
     ...
     public function messages()
    {
        ...
        $ruleMsg['userDetail.provider_type_id.required'] = 'Please select the provider type.';
        $ruleMsg['user_programs.program_id.required'] = 'Please select the programs.';
        $ruleMsg['provider_supervisor.supervisor_id'] = 'Please select supervisor.';
